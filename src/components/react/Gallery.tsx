...
const fetchImagesUpToPage = (images: GalleryImage[], pageSize: number, nextPage: number): GalleryImage[] => {
...
const Gallery: FC<Props> = ({ images }) => {
    ...
    return (
        <>
            <div id={GALLERY_ID} className="pswp-gallery grid grid-cols-1 gap-1 sm:grid-cols-2 lg:grid-cols-3">
